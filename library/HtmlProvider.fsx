...
val stats : (string * decimal) [] =
  [|("4.2", 61982M); ("4.1", 70909M); ("4.0", 39930M); ("3.3", 685800M);
    ("3.2", 17153M); ("3.1", 186992M); ("3.0", 359692M); ("2.4", 402356M);
    ("2.3", 474140M); ("2.2", 284215M); ("2.1", 27859M); ("2.0", 84887M);
    ("1.1", 76036M); ("1.0", 23796M)|]*)
(**
