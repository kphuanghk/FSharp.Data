...
val results : HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="oPP3V7H7wLPV47+HaluSLg==">(function(){
...
val links : (string * string) list =
  [("Google", "/?sa=X&ved=0ahUKEwj7qs65sL_0AhWHkHIEHReIDPIQOwgC");
   ("Google",
    "/?output=search&ie=UTF-8&sa=X&ved=0ahUKEwj7qs65sL_0AhWHkHIEHReIDPIQPAgE");
   ("here", "/search?q=FSharp.Data&ie=UTF-8&gbv=1&sei=27mlYbvRFoehytMPl5CykA8");
   ("News",
